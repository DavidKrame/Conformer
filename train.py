...
parser.add_argument('--normal_layers', type=int,
                    default=2, help='num of normal layers')
parser.add_argument('--enc_lstm', type=int, default=1,
                    help='num of encoder lstm layers')
parser.add_argument('--dec_lstm', type=int, default=2,
                    help='num of decoder lstm layers')
...
parser.add_argument('--attn', type=str, default='long',
